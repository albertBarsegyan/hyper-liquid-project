// Full-screen loader component using Tailwind CSS
...
export function FullScreenLoader({ message = 'Loading' }: Props) {
  return (
    <div
      role="status"
      aria-live="polite"
      className="fixed inset-0 z-50 flex items-center justify-center bg-[#0e1e27]"
    >
      <div className="flex flex-col items-center gap-4">
        ...
        <div className="text-center">
          <p className="text-sm font-medium text-[#97fce4]">{message}</p>
