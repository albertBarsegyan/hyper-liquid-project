  ...
  return (
    <div className="container-responsive py-responsive">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-responsive-3xl font-bold mb-6" style={{ color: '#97fce4' }}>
          About This Project
        </h1>
        ...
        >
          <h2 className="text-responsive-xl font-semibold mb-4" style={{ color: '#97fce4' }}>
            Project Overview
          </h2>
          <p className="text-responsive-base mb-4" style={{ color: '#97fce4', opacity: 0.8 }}>
          ...
          <h3 className="text-responsive-lg font-semibold mb-3" style={{ color: '#97fce4' }}>
            Technologies Used
          </h3>
          <ul className="list-disc list-inside space-y-2" style={{ color: '#97fce4', opacity: 0.8 }}>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-responsive-sm">
            <div>
              <h4 className="font-semibold mb-2" style={{ color: '#97fce4' }}>Key Features</h4>
              <ul className="space-y-1" style={{ color: '#97fce4', opacity: 0.8 }}>
